...
(function(){var s=getSession();if(s){location.href=s.role==='admin'?'pages/statistics.html':'app.html';}})();
...
function checkPin(){
  ...
  hashPIN(pinV).then(function(h){
    if(h===pinSel.pin_hash){
      ...
      location.href=pinSel.role==='admin'?'pages/statistics.html':'app.html';
